...
<body>
    ...
    <!--Home-->
     ...
     <section class="navbar custom-navbar navbar-fixed-top" role="navigation">
          <div class="container">
                                               ...
                                               <div class="navbar-header">
                                                    ...
                                                    <!-- lOGO TEXT HERE -->
                                                    <a href="index.html" class="navbar-brand">Eat <span>&</span> Cook</a>
                                               </div>
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">
                        ...
                        <li><a href="manage.php" class="smoothScroll">Admin</a></li>
     ...
     <!-- MENU-->
     <section id="menu" data-stellar-background-ratio="0.5" style="width:100%;">
          <div class="container">
               <div class="row">

                    <div class="col-md-12 col-sm-12">
                         <div class="section-title wow fadeInUp" data-wow-delay="0.1s">
                              <center><h2>Our Menus</h2></center>
                            <center><h4>Tea Time &amp; Dining</h4></center>
               ...
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                         <div class="footer-info">
                              ...
                              <address class="wow fadeInUp" data-wow-delay="0.4s">
                                 <center> <he><b>Developers</b></he>
                                   <p>01903028309 | 01903028309</p>
                                   <p><a href="mailto:harunk873@gmail.com">harunk873@gmail.com</a></p>
                                   <p>East West University | Dept. of CSE </p></center>
                                   
                              </address>
                         </div>
                    </div>
                    <div class="col-md-6 col-sm-12">
                         <center><ul class="wow fadeInUp social-icon" data-wow-delay="0.4s">
